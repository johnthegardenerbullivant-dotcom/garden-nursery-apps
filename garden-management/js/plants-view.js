...
function buildPlantDetailHTML(plant, instances, photos) {
    ...
    if (plant.hybrid)     searchParts.push('×');
...
export async function showPlantForm(plant, onSave, preselectedAreaId = null) {
    const isEdit = !!plant;
        ...
        <form id="plant-form" autocomplete="off">
            ...
            <div class="form-group">
                <label class="form-label" style="display:flex;align-items:center;gap:8px;cursor:pointer;">
                    <input type="checkbox" name="hybrid" ${plant.hybrid ? 'checked' : ''} style="width:16px;height:16px;accent-color:var(--green-700)">
                    Hybrid (×) — tick if this is a hybrid between two species
                </label>
            </div>
