...
async function showLogForm(batch, onSaved) {
    ...
    showModal('Add Log Entry', `
        <form id="log-form" novalidate>
            <div class="form-group">
                ...
                ${datePicker('log-date', 'date', todayStr())}
            </div>
    ...
    document.getElementById('log-form')?.addEventListener('submit', async e => {
        ...
        try {
            ...
            // Recompute remaining quantity from all logs + outcomes and
            // auto-complete the batch when nothing is left (by any means).
            await recomputeBatchState(batch.id, date);
