...
import { showModal, hideModal, showToast, initPhotoDragSort } from './ui-utils.js';
...
async function showEditLogForm(log, batch, onSaved) {
    ...
    showModal('Edit Log Entry', `
        <form id="edit-log-form" novalidate>
            ...
            <div class="form-group">
                ...
                <input class="form-input" type="date" id="edit-log-date"
                    value="${escHtml(log.date || todayStr())}" required>
            </div>
    ...
    document.getElementById('edit-log-form')?.addEventListener('submit', async e => {
        ...
        const date        = document.getElementById('edit-log-date')?.value || log.date;
